    ...
    <div class="el-item uk-panel uk-margin-remove-first-child">
        <div class="uk-child-width-expand uk-grid" uk-grid="">
            <div class="uk-margin-remove-first-child uk-first-column">
                <h3 class="uk-margin-top uk-margin-remove-bottom">${content.name!} 
                [#if content.mail?has_content]                
                    <a href="mailto:${content.mail!}" class="uk-icon" uk-icon="icon: mail; ratio: 2"></a>
                [/#if]
                </h3>
